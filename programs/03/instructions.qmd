...
1. The ability to instantiate an instance of the SaleItem class. That is, your constructor accepts the appropriate arguments and runs without error and the appropriate instance variables exist and are valid.
    ...
    print(banana.price)     # no error is thrown when accessing banana.price
    print(banana.cost)      # no error is thrown when accessing banana.cost

    # testing accuracy
    print(banana.name == "banana")  # this should print True
    print(banana.price == 1)        # this should print True
    print(banana.cost == 2)         # this should print True

    print(banana.name == "apple")   # this should print False
    print(banana.price == 20)       # this should print False
    print(banana.cost == 40)        # this should print False
    ```
